  ...
  return (
    <div className='flex item-center justify-center w-full min-h-96'>
      <div className='max-w-xl flex flex-col my-5'>
        ...
        <div className="w-full min-w-64 border-2 border-purple-600 dark:border-purple-500 rounded-lg shadow mb-5 p-5 overflow-hidden bg-slate-200 dark:bg-gray-900">
